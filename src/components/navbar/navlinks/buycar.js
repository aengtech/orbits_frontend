...
const BuyCar = () => {
  return (
    <section className="section">
      <h3>Find The Best Online Car Buyying Websites....</h3>
      <div>
        <ul>
          <li>
            <div className="z-depth-2 cyan-lighten-5 row container">
              <h4> CARVANA </h4>
