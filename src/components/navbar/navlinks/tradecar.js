...
import buycars from '../../img/buycars.jpg'
    ...
    <section className="tradehead section blue-grey lighten-5">
      ...
      <div>
        <ul>
          ...
          <li className="cards z-depth-2 teal lighten-5">
            <div className=" cyan-lighten-5">
              <a href="https://autotrader.com/" className="col s4 m4 l4">
          ...
          <li className="cards z-depth-2 teal lighten-5">
            <div className=" cyan-lighten-5">
              <a href="https://cargurus.com/" className="col s4 m4 l4">
                <img src={cargr} alt="cars" className="buycars"/>
                <h4> Car Gurus </h4>
              </a>
                <p className="flow-text brown-text text-darken-2">
...
Setting up listings is simple. Local listings are free and national listings are just $60-$125 and, according to eBay, most cars and trucks sell relatively quickly. Are there downsides to listing on eBay? The biggest downside may be that bids are non-binding, so a buyer can back out for any reason at any point in the process. </p>
          ...
          <li className="cards z-depth-2 teal lighten-5">
            <div className=" cyan-lighten-5">
              <a href="https://hemmings.com/" className="col s4 m4 l4">
                <img src={hems} alt="cars" className="buycars"/>
                <h4> Hemmings </h4>
              </a>
                <p className="flow-text brown-text text-darken-2"> 
